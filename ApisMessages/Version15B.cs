...
{
    class Version15B:ApisEdifactHelper
    {
            ...
            public byte[] Export(FlightResponse flight, string exporterType, bool singleOrMultiPaxLst)
            {
                ...
                using (var ms = new MemoryStream())
                {
                    ...
                    var yearToMin = DateTime.Now.ToString("yyMMdd", enUs) + colon + DateTime.Now.ToString("HHmm", enUs);
                    ...
                    if (!singleOrMultiPaxLst)
                    {
                        ...
                        tw.WriteLine(unh + HTcode + unhMid1 + version15B + unhMid2);
                        tw.WriteLine(bgm745);
                        tw.WriteLine(rffTn+unique+apos);
                        tw.WriteLine(nadMs);
                        tw.WriteLine(com);
                        ...
                        tw.WriteLine(dtm189 + ((DateTime)flight.Sobt).AddSeconds(adepOfset).ToString("yyMMddHHmm", enUs) + dtmEnd);
